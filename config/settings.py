...
MIDDLEWARE = [
    ...
    # 'whitenoise.middleware.WhiteNoiseMiddleware',  # Commented out - not installed
...
# Celery configuration (using database backend for MVP simplicity)
...
CORS_ALLOWED_ORIGINS = [
    ...
    "http://127.0.0.1:3000",
    "http://localhost:8080",  # Django backend
    "http://127.0.0.1:8080",
]
